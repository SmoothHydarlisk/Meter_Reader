...
# 分割模型预测类别id与类别名的对应关系
SEG_CNAME2CLSID = {'_background_': 0, 'scale': 1, 'pointer': 2}
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default='./MODEL/Det_model/')
    parser.add_argument(
        '--seg_model_dir',
        dest='seg_model_dir',
        help='The directory of the segmentation model',
        type=str,
        default='./MODEL/Seg_model/'
    )
    parser.add_argument(
        '--image_dir',
        dest='image_dir',
...
class MeterReader:
    ...
    def roi_crop(self, img, det_results):
        ...
        for res in det_results:
            ...
            # file_name = './demoImage/' + str(random.randint(0, 10000)) + '_.png'
    ...
    def locate_scale(self, line_scales):
        ...
        for i in range(batch_size):
            ...
            name = './demoImage/myp' + str(random.randint(0, 10000)) + '.png'
            #            cv2.imwrite(name, locations)
    ...
    def get_relative_location(self, scale_locations, pointer_locations):
        ...
        for scale_location, pointer_location in zip(scale_locations,
            ...
            print("------------刻度数:%s,指向刻度%s" % (num_scales, pointed_scale), end="-----------\n")
